...
if __name__ == "__main__":
	...
	simulated_datasets.append('OxfordNanopore-pbsim-observed_last-2d-10k');			machine_names.append('nanopore');
	simulated_datasets.append('OxfordNanopore-pbsim-observed_graphmap-2d-10k');		machine_names.append('nanopore');
	simulated_datasets.append('OxfordNanopore-pbsim-observed_last-1d-1k');			machine_names.append('nanopore');
	simulated_datasets.append('OxfordNanopore-pbsim-observed_graphmap-1d-10k');		machine_names.append('nanopore');
