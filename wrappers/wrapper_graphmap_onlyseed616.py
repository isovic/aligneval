...
ALIGNER_PATH = SCRIPT_PATH + '/../aligners/graphmap-onlyseed616/graphmap/';
...
def download_and_install():
	...
	command = 'cd %s; mkdir graphmap-onlyseed616; cd graphmap-onlyseed616; git clone %s' % (basicdefines.ALIGNERS_PATH_ROOT_ABS, ALIGNER_URL);
	subprocess.call(command, shell='True');
	sys.stderr.write('\n');
	...
	command = 'cd %s; git checkout onlyseed616' % (ALIGNER_PATH);
	subprocess.call(command, shell='True');
	sys.stderr.write('\n');
