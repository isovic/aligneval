...
ALIGNER_PATH = SCRIPT_PATH + '/../aligners/graphmap-fixedseed/graphmap/';
...
def download_and_install():
	...
	command = 'cd %s; mkdir graphmap-fixedseed; cd graphmap-fixedseed; git clone %s' % (basicdefines.ALIGNERS_PATH_ROOT_ABS, ALIGNER_URL);
	subprocess.call(command, shell='True');
	sys.stderr.write('\n');
	...
	command = 'cd %s; git checkout fixedseed' % (ALIGNER_PATH);
	subprocess.call(command, shell='True');
	sys.stderr.write('\n');
